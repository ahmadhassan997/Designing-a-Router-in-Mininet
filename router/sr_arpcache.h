...
/* We've been asked to implement this function while pseudocode for this
 this function is defined above.*/
void sr_arpcache_handle_req(struct sr_instance * sr, struct sr_arpreq *arpreq);

/* We need to define this function to check if we need to resend a request
 that has been previously sent or destroy the ARP request after 5 timeouts.
 Pseudocode for this function is defined as well in this header file above.*/
